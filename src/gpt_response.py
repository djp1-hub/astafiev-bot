...
class ChatBot:
    ...
    def get_gpt_response(self, input_text, chat_id, user_id, name, context):
        ...
        content = response_patterns.get(user_id, f"Ты отвечаешь как опытный мужчина белорус который повидал всякое. отвечаешь на русском или белорусском. в конце ответа добавляй С уважением, ваш Бацка, начинай ответ с фразы дорогой {name}")
